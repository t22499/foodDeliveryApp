...
const shop_scroll:any = ref(null)
const picsUl:any = ref(null)
let a = 0
...
//滚动组件
const _initScroll = ()=>{
  const shop = new BScroll(".shop-info",{
    probeType: 3,
    click:true,
    freeScroll:true
  })
  const pics = new BScroll(picsUl.value, {
    scrollX: true, // 水平滑动
    probeType: 3 
  })
}
...
<template>
  <div>
    <div class="shop-info" ref="shop_scroll">
